...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-20 pb-32 sm:pt-32 sm:pb-40">
      {/* Background Gradient */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-8 max-w-lg">
              منصة مَدار توفر لك أنظمة ذكاء اصطناعي متقدمة وقوالب احترافية وأتمتة الأعمال. كل ما تحتاجه لتطوير عملك الرقمي في مكان واحد.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-4 bg-gradient-to-r from-[#6C3BFF] to-[#00C2A8] text-white rounded-lg font-semibold hover:shadow-2xl transition-all transform hover:scale-105">
                استكشف المنتجات
              </button>
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            <div className="relative">
              ...
              {/* Floating Card 1 */}
              <div className="absolute -top-8 -right-8 bg-white rounded-2xl p-6 shadow-xl border border-[#E2E8F0] w-64 transform hover:scale-105 transition-transform">
              ...
              {/* Floating Card 2 */}
              <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl p-6 shadow-xl border border-[#E2E8F0] w-64 transform hover:scale-105 transition-transform">
                <div className="flex items-center gap-3 mb-3">
