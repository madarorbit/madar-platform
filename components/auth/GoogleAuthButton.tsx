...
export default function GoogleAuthButton({ next, className = '' }: Props) {
  ...
  return (
    <a href={href} className={`md-google-button ${className}`} aria-label="المتابعة باستخدام Google">
      <span className="md-google-mark" aria-hidden="true">
      ...
      <span className="md-google-label">المتابعة باستخدام Google</span>
    </a>
  );
}
