 ...
 return <button type="button" onClick={toggle} className={`md-theme-toggle${compact?' md-theme-toggle-compact':''}`} aria-label={label} title={label} aria-pressed={!isLight}>
  <span className="md-theme-toggle-track" aria-hidden="true">
   <span className="md-theme-toggle-thumb">
    {isLight?<svg viewBox="0 0 24 24" className="md-theme-icon" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"/></svg>:<svg viewBox="0 0 24 24" className="md-theme-icon" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20.5 14.2A8.5 8.5 0 0 1 9.8 3.5a8.5 8.5 0 1 0 10.7 10.7Z"/></svg>}
   </span>
  </span>
