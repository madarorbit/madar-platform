...
import type {StoreCategory,StoreSearchResponse} from '@/src/lib/store/types';
...
export default async function StorePage(){
 let featured:StoreSearchResponse={items:[],total:0,page:1,pageSize:3,hasMore:false};
 let latest:StoreSearchResponse={items:[],total:0,page:1,pageSize:6,hasMore:false};
