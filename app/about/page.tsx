...
export const metadata = {
  title: "عن مَدار",
  description:
    "رؤية مَدار ورسالتها ومنهجها في إدارة التجارة ورقمنة الأعمال العربية.",
};
        ...
        <div className="mt-14">
          <ContentSections
            sections={[
              {
                title: "العربية أولًا",
                body: "نبني المصطلحات والتدفقات والواجهات انطلاقًا من احتياجات المستخدم العربي، لا كترجمة لاحقة لمنتج أجنبي.",
                icon: "community",
              },
              {
                title: "العملية قبل الاستعراض",
                body: "قيمة الحل تقاس بقدرته على تقليل التشتت وتحسين القرار وتوفير الوقت، لذلك نبدأ من المشكلة التشغيلية.",
                icon: "automation",
              },
              {
                title: "الأمان والملكية",
                body: "نعزل بيانات العملاء، ونطبّق الصلاحيات بأقل امتياز لازم، ونوضح حدود كل خدمة ومنتج.",
                icon: "shield",
              },
              {
                title: "بنية قابلة للتوسع",
                body: "نبني مكونات مستقلة ومترابطة حتى تنمو المنصة من دون هدم ما سبق أو ربط العميل بأداة واحدة.",
                icon: "layers",
              },
            ]}
          />
            ...
            <div className="relative grid items-center gap-8 p-6 sm:p-10 lg:grid-cols-[.78fr_1.22fr]">
              ...
              <div>
                ...
                <h2 className="mt-5 text-4xl font-black sm:text-5xl">
                  أوربي يفهم سياق عملك، لا سؤالك فقط
                </h2>
                <p className="mt-5 text-lg leading-9 text-slate-300">
                ...
                <Grid className="mt-7 sm:grid-cols-2" auto={false}>
                  <div className="md-card md-card-subtle">
                    <Icon name="chart" className="text-emerald-300" />
                    <strong className="mt-3 block">تحليل وتشخيص</strong>
                    <p className="mt-2 text-sm leading-6 text-slate-400">
                      يلخص المؤشرات ويكشف التغيرات والمخاطر التشغيلية.
                    </p>
                  </div>
                  <div className="md-card md-card-subtle">
                  ...
                  <div className="md-card md-card-subtle">
                    <Icon name="document" className="text-violet-200" />
                    <strong className="mt-3 block">فهم سياق العمل</strong>
                    <p className="mt-2 text-sm leading-6 text-slate-400">
                      يدعم التحليل التجاري والتلخيص والشرح ضمن بيانات الخدمة المصرح بها.
                    </p>
                  </div>
                </Grid>
