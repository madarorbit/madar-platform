...
export default function AppearancePage() {
  return (
    <AccountPage size="narrow">
      ...
      <section className="md-account-section"><h2>مظهر المنصة</h2><p className="md-type-body-sm md-muted mt-2">اختر فاتحًا أو داكنًا، أو اترك مَدار تتبع إعداد النظام.</p><ThemePreferences /></section>
      <section className="md-account-section mt-5"><h2>اللغة والاتجاه</h2><p className="md-type-body-sm md-muted mt-2">العربية واتجاه RTL هما الأساس الحالي. النصوص الإنجليزية والأكواد والعملات تبقى باتجاهها الصحيح داخل الحقول والجداول.</p><button disabled className="md-button md-button-secondary mt-4">العربية · RTL</button></section>
    </AccountPage>
  );
}
