...
const activationMessages:Record<string,{title:string;body:string}>={
 ...
 'runtime-state-persistence-failed':{title:'تعذر حفظ حالة التفعيل',body:'نجح فحص المزود، لكن تعذر تثبيت نتيجة الفحص أو حالة التشغيل في قاعدة البيانات. بقيت بوابات أوربي مغلقة بأمان.'},
