...
const refresh=()=>{for(const path of ['/admin/orby-os','/admin/orby-os/workflows','/admin/orby-os/prompts','/admin/orby-os/evaluations','/admin/orby-os/observability','/admin/orby-os/models','/admin/orby-os/data'])revalidatePath(path);};
