...
function runReadinessSmoke(){return new Promise((resolve,reject)=>{
 const child=spawn(process.platform==='win32'?'npx.cmd':'npx',['tsx','scripts/run-integration-readiness-smoke.mts'],{cwd:new URL('..',import.meta.url),env:{...process.env,NODE_ENV:'test'},stdio:['ignore','pipe','pipe']});let stdout='',stderr='';
