...
const noIndexRoutes=['/admin/:path*','/account/:path*','/workspace/:path*','/workspace-payment/:path*','/retail/onboarding','/retail/workspace/:path*','/student/:path*','/dashboard','/onboarding','/auth/:path*','/api/:path*','/checkout','/cart','/order-confirmation','/payment/:path*','/forgot-password','/reset-password','/login','/register','/maintenance','/search','/blog/manage/:path*'];
