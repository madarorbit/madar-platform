...
export function createOrbyFoundation(options:CreateOrbyFoundationOptions={}){
 ...
 const kernel=new OrbyKernel({configuration,sessions,context,routing,events,logger});return{kernel,configuration,configurationStore,providers:providerRegistry,models:modelRegistry,capabilities,context,sessions,sessionStore,routing,health,events,logger};
}
