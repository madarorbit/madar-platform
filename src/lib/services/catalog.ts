...
export const services: readonly ServiceDefinition[] = [
 {code:"CONNECT_EXISTING",name:"ربط تجارة قائمة بمَدار",shortName:"ربط تجارة قائمة",description:"اربط نظامك الحالي بمحرك الموصلات والتحليلات في مَدار.",detail:"يبقى نظامك القائم مصدر الحقيقة، وتعمل طبقات الربط وفق الصلاحيات التي تعتمدها.",icon:"automation",coverImage:"/services/connect-existing.webp",openHref:"/account/services/CONNECT_EXISTING/open",runtimeHref:"/workspace/connect",accent:"mint"},
 {code:"BUILD_ON_MADAR",name:"بناء تجارة جديدة على مَدار",shortName:"بناء تجارة جديدة",description:"ابدأ تجارة جديدة باستخدام المساحات والقطاعات الموجودة في مَدار.",detail:"يبدأ إعداد القطاع والمساحة بعد اعتماد الخدمة، وليس أثناء إنشاء الحساب.",icon:"layers",coverImage:"/services/build-on-madar.webp",openHref:"/account/services/BUILD_ON_MADAR/open",runtimeHref:"/workspace",accent:"violet"},
