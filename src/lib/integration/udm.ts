...
export const UDM_ENTITY_TYPES=['organization','workspace','branch','product','category','customer','order','order_item','sale','payment','inventory','inventory_movement','supplier','expense','employee','operational_event'] as const;
