...
| ORBY Master | الشخصية الرسمية في المساحات البارزة | `public/assets/orby/orby-master.png` | JPEG payload 1536×1536 باسم `.png` | ACTIVE MASTER | Master المرفق SHA-256 `1460c30f8514bed9df2bc3ee280ad3927e315b15112faafbad1e3226d61c238e`؛ repo Git blob `a213830b95960f5118596635ce5dd2328a853dbf` | About/intro/major explanation | لا recolor؛ semantic frame حوله | يستخدم مباشرة؛ لا generated derivative ولا crop |
...
| Connected Business Service | Master لخدمة ربط تجارة قائمة | `public/assets/services/connected-business-master.png` | PNG 1254×1254 | ACTIVE MASTER | Master المرفق SHA-256 `ea6bec6a7f763a0a3039efca523074070ba466964dc1f32c77600c99355b5247`؛ repo Git blob `34d43f28b9e23ed95e9940b552da55738408b16f` | Service cards / service selection | لا recolor؛ contain داخل semantic surface | يستخدم مباشرة؛ لا thumbnail ولا crop |
| Native Business Service | Master لخدمة بناء تجارة على مَدار | `public/assets/services/native-business-master.png` | PNG 1254×1254 | ACTIVE MASTER | Master المرفق SHA-256 `3466fac360f9a346557036c27169fb7b487a71aa312f6299ca45bbbb571513c6`؛ repo Git blob `5b23af11150f65fe8c79ebce1626468780284984` | Service cards / service selection | لا recolor؛ contain داخل semantic surface | يستخدم مباشرة؛ لا crop للتكوين الأصلي |
| MADAR Retail Service | Master لخدمة MADAR Retail | `public/assets/services/madar-retail-master.png` | PNG 1254×1254 | ACTIVE MASTER | Master المرفق SHA-256 `398ee11e7164696db7916b1ab3e60da0517c112bc4942de23e647dad0ecdcbab`؛ repo Git blob `41dec7e503401f8a39c5d92e9f475feef9a66d78` | Service cards / service selection | لا recolor؛ contain داخل semantic surface | يستخدم مباشرة؛ لا crop للتكوين الأصلي |
